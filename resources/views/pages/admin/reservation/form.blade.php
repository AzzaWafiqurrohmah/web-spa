...
<div class="row">
     <div class="col-md-8" style="">
        <div class="card">
            <h5 class="ms-3 mb-0 mt-3">Detail Reservasi</h5>
            <div class="card-body">
                <div class="mb-3">
                    <div class="row">
                        <div class="col-lg-6">
...
{{--                                        <input type="hidden" name="customer_member" value=" {{ $customer->is_member }} ">--}}
                                    @endif
                                </select>
                                <input type="hidden" name="customer_member" id="customer_member" value=" {{ $customer?->is_member ?? 0 }} ">
                                @error("customer_id")
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <label for="transport_cost">Tarif Transportasi </label>
                            <div class="mb-4">
                                <div class="input-group mb-1">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" name="transport_cost" id="transport_cost" aria-describedby="basic-addon1" class="form-control @error('transport_cost') is-invalid @enderror" value="{{ old('transport_cost', $reservation?->transport_cost ?? '') }}">
                                </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                <div class="input-group mb-1">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" name="discountAdd" id="discountAdd" aria-describedby="basic-addon1" class="form-control @error('discountAdd') is-invalid @enderror" value="{{ old('discountAdd', $additional_disc ?? 0) }}">
                                </div>
                                @error("discountAdd")
                                <small class="text-danger mb-3">{{ $message }}</small>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="packet">Pilih Paket Treatment : </label>
                                <select class="packet-option form-control @error('packet') is-invalid @enderror" @disabled($customer == null)></select>
                                @error("packet")
                                <small class="text-danger mb-3">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="treatment-option form-control @error('treatment') is-invalid @enderror" @disabled($customer == null)></select>
                                @error("treatment")
                                <small class="text-danger mb-3">{{ $message }}</small>
                                @enderror
                            </div>
                ...
                <p id="treatment">Paket / Treatment yang dipilih: </p>
                <div class="row" id="treatment-container">
                    @if(isset($reservation) || old('treatments'))
                        @foreach($packetsModal as $packet)
                                ...
                                <div class="card" >
                                    <div class="card-body d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="m-0">{{$packet->packet_price}}</p>
                                        </div>
                                        <span class="position-absolute top-0 end-0 me-2 btn-delete" data-id="P{{$packet->id}}" style="font-size: 1.4rem; cursor: pointer">
                                            <i class="bi bi-x"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-3" >
                                ...
                                <div class="card" >
                                    <div class="card-body d-flex gap-4 align-items-center">
                                        ...
                                        <span class="position-absolute top-0 end-0 me-2 btn-delete" data-id="T{{$treatment->id}}" style="font-size: 1.4rem; cursor: pointer">
                                            <i class="bi bi-x"></i>
                                        </span>
                                    </div>
                                </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <h5 class="ms-3 mb-0 mt-3">Reservation Summary</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-lg-end" style="margin-bottom: 0px">
                            <p id="discString" style="margin-bottom: 2px; font-weight: bold; font-size: 14px">
                                Rp {{ old('discTreatment') ?? ($disc_treatment ?? 0) }}
                            </p>
                            <input type="hidden" name="discTreatment" id="discTreatment" value="{{($disc_treatment ?? 0) }}">
