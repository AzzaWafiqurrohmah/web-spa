...
<div class="card my-4 container">
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-md-8 d-flex align-items-center gap-4 mb-4">
            ...
            <div class="col-md-4 rounded bg-light px-3 py-2 d-flex align-items-center gap-4">
                <div>
                ...
                @if ($reservation->payment_type == 'cash')
                    <div class="badge bg-success" style="font-size: 1rem;">Cash</div>
                @elseif ($reservation->payment_type == 'transfer')
                    <div class="badge bg-info" style="font-size: 1rem;">Transfer</div>
                @endif
            </div>
        </div>
